...
constexpr double FLOAT_NAN = std::numeric_limits<double>::quiet_NaN();
constexpr double FLOAT_INF = std::numeric_limits<double>::infinity();
...
inline void WriteFloat(WriteContext &context, double value) {
